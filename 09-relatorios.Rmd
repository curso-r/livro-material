...
O RMarkdown é um pacote no R que possibilita criar documentos relatórios reprodutíveis. Este pacote possibilita a escrita em um arquivo do tipo `.Rmd`, onde é possível adicionar textos, códigos, os resultados dos códigos, e muito mais!
