...
knitr::include_graphics(rep("img/instalacao/01-r-salvo.png"))
```
...
```{r echo=FALSE, fig.align='center'}
knitr::include_graphics(rep("img/instalacao/06-r-pasta.png"))
```
...
```{r echo=FALSE, fig.align='center'}
knitr::include_graphics(rep("img/instalacao/09-conclusao.png"))
```
...
<img src="https://user-images.githubusercontent.com/8967307/45383184-db384580-b5e0-11e8-8bac-dd40a4d7e76f.png" style="width: 80%;">
...
```{r echo=FALSE, fig.align='center'}
knitr::include_graphics(rep("img/instalacao/rstudio-download-opt.png"))
```
...
```{r echo=FALSE, fig.align='center'}
knitr::include_graphics(rep("img/instalacao/rstudio-instalador.png"))
```
...
```{r echo=FALSE, fig.align='center'}
knitr::include_graphics(rep("img/instalacao/rstudio-zip.png"))
```
...
```{r echo=FALSE, fig.align='center'}
knitr::include_graphics(rep("img/instalacao/rstudio-extrair.png"))
```
...
```{r echo=FALSE, fig.align='center'}
knitr::include_graphics(rep("img/instalacao/extrair-tudo-rstudio.png"))
```
...
```{r echo=FALSE, fig.align='center'}
knitr::include_graphics(rep("img/instalacao/rstudio-bin.png"))
```
...
```{r echo=FALSE, fig.align='center'}
knitr::include_graphics(rep("img/instalacao/rstudio-linux.png"))
```
...
```{r echo=FALSE, fig.align='center'}
knitr::include_graphics(rep("img/instalacao/instalar_pacote_rstudio.png"))
```
