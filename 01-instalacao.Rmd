...
Também é possível instalar outros programas que possibilitam o uso do LaTex. A seguir estão apresentadas algumas opções!
...
O rtools é apenas necessário para computadores que utilizem o sistema operacional Winddows. Para instalá-lo, clique [neste link](https://cran.r-project.org/bin/windows/Rtools/) e faça o download do arquivo instalador referente à sua versão do Windows (32 ou 64 bits). Abra o arquivo baixado para realizar a instalação. 
