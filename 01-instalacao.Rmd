...
Um editor de LaTex que apresenta versão para Mac é o MikTex. Para instalá-lo, primeiramente faça o download do arquivo `.dmg` [através deste link](https://miktex.org/download#mac). [Este tutorial](https://miktex.org/howto/install-miktex-mac) apresenta todos os passos de instalação no Mac, porém abaixo também vamos descrever os passos:

1. Faça o download do arquivo `.dmg` [através deste link](https://miktex.org/download#mac)

2. Abra o arquivo baixado. Uma janela irá abrir, e você deve arrastar o ícone "MiKTeX Console" para a pasta "Applications" (como mostrado na animação abaixo). 

```{r echo=FALSE}
knitr::include_graphics("img/gif_miktex.gif")
```

3. No Launchpad (menu de arquivos instalados), procure o ícone do "MiKTeX Console" e abra-o. Você também pode usar a pesquisa do Mac (utilizando o atalho Command + Barra de espaço), pesquisando por MiKTeX para abrir o arquivo.
...
```{r echo=FALSE}
knitr::include_graphics("img/miktex-instalacao-1.gif")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/miktex-instalacao-2.gif")
```
6. Após instalar e atualizar, o editor MiKTeX está pronto para uso!
...
Outra opção é a utilização do LibreOffice, que pode ser instalado através [deste link](https://pt-br.libreoffice.org/baixe-ja/libreoffice-novo/), escolhendo o sistema operacional "MacOS" e clicando em "Baixar". 
