...
No caso do desenvolvimento de pacotes, você pode verificar se já possuí as ferramentas de desenvolvimento instaladas usando a seguinte função: `devtools::has_devel()`. Caso a mensagem retornada seja _"Your system is ready to build packages!"_, significa que você já tem as ferramentas necessárias instaladas.
