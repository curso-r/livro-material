...
knitr::include_graphics("assets/img/pacotes/ciclo-ciencia-de-dados-pacotes.png")
...
```{r, out.width = "500pt", out.height = "500pt", fig.align="center", echo = FALSE}
knitr::include_graphics("assets/img/pacotes/tidyverse_celestial.png")
```
