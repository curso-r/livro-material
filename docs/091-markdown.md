...
|  Como é escrito no código |  Como aparece no relatório |
|--:|--:|
| `# Título 1` <br> `## Título 2` <br> `### Título 3` |  <img src="assets/img/relatorios/titulos.png" width="340" />| 
...
|  Como é escrito no código |  Como aparece no relatório |
|--:|--:|
|`![Logo da Curso-R](assets/img/relatorios/logo_cursor_full.png)`| ![Logo da Curso-R](assets/img/relatorios/logo_cursor_full.png)| 
