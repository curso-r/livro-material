...
```{r echo=FALSE, fig.align='center'}
knitr::include_graphics(rep("img/rstudio/exemplo-projeto-aberto.png"))
```
...
```{r echo=FALSE, fig.align='center'}
knitr::include_graphics(rep("img/rstudio/exemplo-lista-projetos.png"))
```
...
```{r echo=FALSE, fig.align='center', out.width=700, out.height=600}
