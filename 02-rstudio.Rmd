...
knitr::include_graphics(rep("assets/img/rstudio/github_rep.png"))
```
...
```{r , echo=FALSE, fig.align='center'}
knitr::include_graphics(rep("assets/img/rstudio/aba_git.png"))
```
...
```{r  echo=FALSE, fig.align='center'}
knitr::include_graphics(rep("assets/img/rstudio/git_commit.png"))
```
...
```{r cheatsheet-rstudio, echo=FALSE, fig.align='center', out.width=700, out.height=600}
