...
- **b.** generalize a função para retornar um número qualquer de linhas, escolhido na hora de chamá-la.
...
Nesses casos, é muito comum o uso das funções `return()` e `stop()` para, respectivamente, retornar um resultado antecipadamente ou parar a execução da função e devolver ao usuário uma mensagem de erro personalizada.
