...
knitr::include_graphics(rep("img/r-base/ajuda_google.png"))
```
...
Mas, da mesma forma que é muito mais fácil aprendermos a fritar um ovo após aprendermos o que são fogões, frigideiras e ovos, vamos estudar nas próximas seções um pouco sobre as estruturas que formam os *data frames* e ficar mais à vontade com esses objetos.
